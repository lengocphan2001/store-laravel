...
!(function(t, e) {
            ...
            return function(i, d, p) {
                for (
                    var v,
                        ...
                        x = f(m.length),
                        E = 0,
                        w = r ? h(i, x) : n ? h(i, 0) : void 0; x > E; E++
                )
        ...
        jt = function(t, e) {
            ...
            if ((i = l ? E : c ? E[a] || R(a, {}) : (E[a] || {}).prototype))
                for (r in e) {
                    if (
                        ((s = e[r]),
                            (n = t.noTargetGet ? (o = Rt(i, r)) && o.value : i[r]), !Tt(l ? r : a + (c ? "." : "#") + r, t.forced) && void 0 !== n)
                    ) {
    ...
    var Ft =
        ...
        function(t, e) {
            for (
                var i = a(t), r = arguments.length, n = 1, o = Et.f, l = X.f; r > n;
    ...
    function Gi(t) {
        ...
        var r = qi(t).getComputedStyle(t),
            n = (function(t) {
                for (
                    var e = {}, i = 0, r = ["top", "right", "bottom", "left"]; i < r.length; i++
                ) {
                    var n = r[i],
                        s = t["padding-" + n];
                    e[n] = Yi(s);
        ...
        if (
            ("border-box" === r.boxSizing &&
                (Math.round(a + s) !== e && (a -= Xi(r, "left", "right") + s),
                    Math.round(l + o) !== i && (l -= Xi(r, "top", "bottom") + o)), !(function(t) {
    ...
    var or = (function() {
        ...
        return (
            ...
            (e.initListeners = function() {
                var t = this;
                this.options.autoHide &&
                    this.el.addEventListener("mouseenter", this.onMouseEnter), ["mousedown", "click", "dblclick"].forEach(function(e) {
            ...
            (e.removeListeners = function() {
                var t = this;
                this.options.autoHide &&
                    this.el.removeEventListener("mouseenter", this.onMouseEnter), ["mousedown", "click", "dblclick"].forEach(function(e) {
