...
use App\Helpers\DataHelper; @endphp
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.categories.update', ['category' => $data['category']->id]) }}"
                            method="POST">
                            @method('PUT')
                            @csrf
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input name="name_category" type="text" class="form-control"
                                        id="horizontal-firstname-input" value="{{ $data['category']->name }}">
                                    @error('name_category')
